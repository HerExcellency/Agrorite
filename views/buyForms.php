        ...
        <div class="col-12 col-md-8 col-lg-8">
          <div class="contact-form">
            ...
            <form class="form-group" id="contact-form">
              ...
              <div class="row">
                <div class="col-12 col-md-6">
                  <input class="form-control" type="text" name="subject" id="contact_subject" placeholder="Company's Name">
                </div>
                <div class="col-12 col-md-6">
            ...
            <div class="row">
                <div class=" col-12 col-md-6 ">
                    <div class="form-group">
                        ...
                        <select id="country" name="country" type="text" required class="form-control" placeholder="Select Country">
                ...
                <div class="col-12 col-md-6" style="align-self: center">
                    <div class="form-group">
                        ...
                        <label for="img"></span><input type="file" id="proposal" name="proposal" required="true" accept=".doc,.docx,application/msword,.pdf">
