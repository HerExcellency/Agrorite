      ...
      <div class="container-fluid">
          <div class="row"> 
            <div class="liveDataTitle">
              <h5 class="marqTitle">Commodity Traded</h5>
            </div>
            <div class="marquee3k tradeProducts align-items-center" data-speed="0.25" data-pausable="bool">
                ...
                <p class="tradeP">
                 ...
                 <span style=" margin-left:5px;color: #eeeeee,f padding-left: 3px; padding-right: 3px"> Paddy rice Long Grain <b> #222.140 </b><i class="tradeProfit"> 9.5% </i></span>
                 <span style=" margin-left:5px;color: #eeeeee, padding-left: 3px; padding-right: 3px"> Maize <b> #400 </b><i class="tradeLoss"> 2.8% </i></span>
                 <span style=" margin-left:5px;color: #eeeeee, padding-left: 3px; padding-right: 3px"> Ginger <b> #700 </b><i class="tradeLoss"> 2.8% </i></span>
                 <span style=" margin-left:5px;color: #eeeeee, padding-left: 3px; padding-right: 3px"> Sesame <b> #480 </b><i class="tradeLoss"> 2.8% </i></span>
                </p>
              </a>                   
            </div>
          </div>
    ...
    <!-- <div class="show bg-3" style="color:#fff; font-size:12px; margin-bottom:0px;">
      <div class="container" >
        <div class="row mCenter">
          <div class="col-lg-9 col-md-8 col-sm-7 col-12 mysize" style="color:#000;"><h5>Africa's #1 Digital Agricultural Brand</h5></div>
          <div class="col-lg-3 col-md-4 col-sm-5 col-12 myTop mysize"><h5><a style="color:#000;" href="tel:+2348035429041" >Hotline: +234 803 542 9041</a></h5></div>
        </div>
      </div>
    </div> -->
