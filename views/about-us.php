...
?>
  <link rel="stylesheet" href="<?php echo $urlLink; ?>/assets/css/about.css">
   ...
   <div class="container-fluid bg-3">
    <section class="section-ptb bb-2 mysection4 negative_top">
      ...
      <div class="row">
                    ...
                    <div class="row gy-4 gy-lg-0">
                            ...
                            <div class="widget-navigation wow fadeInUp pe-lg-4" data-wow-delay="0.1s">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link active" id="2021-tab" data-bs-toggle="tab" href="#twenty1"
                                            role="tab" aria-controls="twenty1" aria-selected="true">2021</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link" id="2020-tab" data-bs-toggle="tab" href="#twenty"
                                            role="tab" aria-controls="twenty" aria-selected="false">2020</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link " id="" data-bs-toggle="" href="<?php echo $urlLink; ?>/our-story"
                                            role="" aria-controls="" aria-selected="">See All</a>
                                    </li>
                        ...
                        <div class="col-lg-4 col-7">
                            <div class="tab-content wow fadeInUp" data-wow-delay="0.3s" id="myTabContent">
                                ...
                                <div class="tab-pane fade" id="twenty" role="tabpanel" aria-labelledby="2020-tab">
                                    <h3  style="margin-top: 0px; color: #07c507">2020</h3>
                                    <p>Africa's Fintech Innovators Merit Award</p>
                                    <p>Official launching of Agrorite Limited in Guinea Bissau, East Africa.</p>
                                    
                                    <p>Parnership Agreement with GoGlobal LLC in the US</p>
                                    <p>Airbus Africa4Future Cohort</p>
                                    <p>Corporate Member, Dubai Chamber of Commerce</p>
                                    


                                </div>
                                <div class="tab-pane fade" id="nineteen" role="tabpanel" aria-labelledby="2019-tab">
                                    <h3  style="margin-top:0px; color: #07c507">2019</h3>
                                    <p>CEO Listed as 5th Global Entreps and 5G Citizens International Congress member</p>
                                    <p>Presidential award to the CEO on Social Impact</p>
                                    <p>Agrorite was launched</p>
                            
                                </div>
                               
                                <div class="tab-pane fade" id="seeMore" role="tabpanel" aria-labelledby="seeMore-tab">
                                    <h3  style="margin-top: 0px; color: #575757">2019 and before</h3>
                                    <p>Official launching of Agrorite Limited in Guinea Bissau, East Africa.</p>
                        ...
                        <div class="col-xl-4 col-lg-5 offset-xl-1 pr-lg-35 pl-lg-35">
                            <div class="accolades-widget wow fadeInUp" data-wow-delay="0.5s">
                                <div class="accolades-header d-flex justify-content-between align-items-end">
                                    <h2>Awards</h2>
                                    <img style="max-width: 11%" src="assets/img/icon/awardGreen.png" alt="icon">
                                </div>
                                <div class="accolades-content">
                                    <ul style="list-style-type: none">
                                        <li class="">

                                            <p class="subtitle"> Africa's most impactful Agricultural brand </p>
                                            <p style="color:#07c507" class="text">Global quality excellence and African brands award</p>
                                        </li>
                                        <li class="">
                                            <p class="subtitle">50 influential CEOS in Africa</p>
                                            <p style="color:#07c507" class="text">Young Entrepreneurs International Summit.</p>
                                        </li>
                                        <li class="mt-3">
                                            <p class="subtitle">40under40 CEO in Nigeria</p>
                                            <p style="color:#07c507" class="text">Young Entrepreneurs International Summit.</p>
                                        </li>
                                        <li class="mt-3">
                                            <p class="subtitle">West Africa's Brand Excellence Awards </p>
                                            <p style="color:#07c507" class="text">Institute of Brand Management of Nigeria</p>
                                        </li>

                                        <li class="mt-3">
                                            <p class="subtitle">Award of Excellence and Integrity  </p>
                                            <p style="color:#07c507" class="text">Nelson Mandela Leadership</p>
                                            
                                        </li>
                                        <li class="mt-3">
                                            <p class="subtitle">Africa's Most Innovative Digital Agriculture Platform Brand</p>
        ...
        <section class="recognition-area bg_white pt-135 pb-140 media RecognitionMobile">
                ...
                <div class="recognition-widget pt-50">
                    <div class="row gy-4 gy-lg-0">
                        <div class="col-lg-3 col-3">
                            <div class="widget-navigation wow fadeInUp pe-lg-4" data-wow-delay="0.1s">
                                <ul class="nav nav-tabs" id="mobileTab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link active" id="mobile2021" data-bs-toggle="tab" href="#mobile21"
                                            role="tab" aria-controls="mobile21" aria-selected="true">2021</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link" id="mobile2020" data-bs-toggle="tab" href="#mobile20"
                                            role="tab" aria-controls="mobile20" aria-selected="false">2020</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link" id="mobile2019" data-bs-toggle="tab" href="#mobile19"
                                            role="tab" aria-controls="mobile19" aria-selected="false">2019</a>
                                    </li>
                        ...
                        <div class="col-lg-4 col-9">
                            <div class="tab-content wow fadeInUp" data-wow-delay="0.3s" id="mobileTabContent">
                           
                                <div class="tab-pane fade show active" id="mobile21" role="tabpanel" aria-labelledby="mobile21">
                                    <h3 style="margin-top: 0px; color: #07c507">2021</h3>
                                    <p class="moreTextMobile awardTextMobile"> Our Founder, Toyosi Ayodele, was honored for his outstanding contributions to the agricultural sector at the 30 Under 30 Africa awards.</p>
                                    <p class="moreTextMobile awardTextMobile">Member of the Nigerian-British Chamber of Commerce </p>
                                    <p class="moreTextMobile awardTextMobile">Africa's most impactful Agricultural brand 2021 at the Global quality excellence and African brands award</p>
                                    <p class="moreTextMobile awardTextMobile">Emmanuel Macron and the France government invited Agrorite to Montepelier, France</p>
                                    <p class="moreTextMobile awardTextMobile">Agrorite's Founder & CEO, Toyosi Ayodele was awarded 50 influential CEOs in Leadership and Business Sustainability in Africa.</p>
                                    <p class="moreTextMobile awardTextMobile">Official launching of Agrorite Limited in Guinea Bissau, East Africa.</p>
                                ...
                                <div class="tab-pane fade" id="mobile20" role="tabpanel" aria-labelledby="mobile20">
                                <h3  style="margin-top: 0px; color: #07c507">2020</h3>
                                    <p>Africa's Fintech Innovators Merit Award</p>
                                    <p>Official launching of Agrorite Limited in Guinea Bissau, East Africa.</p>
                                ...
                                <div class="tab-pane fade" id="mobile19" role="tabpanel" aria-labelledby="mobile19">
                                <h3  style="margin-top: color: #07c507">2019</h3>
                                    <p>CEO Listed as 5th Global Entreps and 5G Citizens International Congress member</p>
                                    <p>Presidential award to the CEO on Social Impact</p>
                                    <p>Agrorite was launched</p>
                                </div>
                               
                                <div class="tab-pane fade" id="seeMoreMobile" role="tabpanel" aria-labelledby="seeMoreMobile">
                                    <h3  style="margin-top: 0px; color: #07c507">2019 and before</h3>
                                    <p>Official launching of Agrorite Limited in Guinea Bissau, East Africa.</p>
                        ...
                        <div class="col-xl-4 col-lg-5 offset-xl-1 pr-lg-35 pl-lg-35" style="margin-top: 19%">
                            <div class="accolades-widget wow fadeInUp" data-wow-delay="0.5s">
                                <div class="accolades-header d-flex justify-content-between align-items-end">
                                    <h2>Awards</h2>
                                    <img style="max-width: 11%" src="assets/img/icon/awardGreen.png" alt="icon">
